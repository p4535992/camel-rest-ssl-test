...
/**
 * @href https://github.com/emmostrom/CamelRestAuth/blob/master/src/main/java/com/edwardm/AuthenticationInterceptor.java
 * To access the test3 endpoint add the 'User Token' header with the value '987654'
 */
